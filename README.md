# UI Lab 2 
Виконала Жаботинська Софія, студентка 35 групи

В power shell на жаль не вдалось запустити програму, тому запуск був у звичайний спосіб
## Завдання на 3
